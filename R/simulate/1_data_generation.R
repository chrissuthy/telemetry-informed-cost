...
file_main <- paste0("output/", select_ups, "/model_data/")


saveRDS(landscape_ALL,   paste0(file_main, "landscape.RData"))
saveRDS(ss,              paste0(file_main, "ss.RData"))
saveRDS(teldata_raw_ALL, paste0(file_main, "teldata_raw.RData"))
saveRDS(tracks_all,      paste0(file_main, "tracks_all.RData")) 
saveRDS(cost.data_ALL,   paste0(file_main, "cost_data.RData"))
