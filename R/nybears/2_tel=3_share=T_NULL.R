...
ASE <- mm_forest$hessian[2:6,2:6] %>% solve %>% diag %>% sqrt
ASE <- c(NA, ASE)
...
write.table(out, "./output/nybears/ntel=3_share=T_MSE_SE_NULL.txt")
save.image("./output/nybears/ntel=3_share=T_NULL.RData")
